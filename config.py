...
# Bot (CHANGE THE NAME TO REGISTER_SERVER_PUBLIC_KEY_HEX IF YOU WANT THE NODES TO NOT FILTER OUT THE BOT'S MESSAGES). MAKE SURE TO ALSO COMMENT OUT THE REAL REGISTER_SERVER_PUBLIC_KEY_HEX AT LINE 40.
